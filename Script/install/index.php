...
function check_($check)
{
  ...
  $file              = file_get_contents('https://url.codegood.net/purchase.php?code=' . $check . '&url=' . $siteurl, false, stream_context_create($arrContextOptions));
  if ($file) {
...
function check_success($check)
{
  ...
  $file              = file_get_contents('https://url.codegood.net/purchase.php?code=' . $check . '&success=true&url=' . $siteurl, false, stream_context_create($arrContextOptions));
  if ($file) {
    $check             = json_decode($file, true);
  } else {
    $check             = array('status' => 'SUCCESS', 'url' => $siteurl, 'code' => $check);
...
`name` = 'is_ok'");
        ...
        $query_one = mysqli_query($con1, "UPDATE `Wo_Config` SET `value` = '" . mysqli_real_escape_string(
          $con1,
          md5(microtime())
        ) . "' WHERE `name` = 'widnows_app_api_id'");
...
VALUES ('" . mysqli_real_escape_string($con1, $_POST['admin_username']) . "', '" . mysqli_real_escape_string(
          $con1,
          sha1($_POST['admin_password'])
        ) . "','" . mysqli_real_escape_string($con1, $_POST['siteEmail']) . "'
            ...
            <div class="setting-well">
              <?php if ($page == 'terms') { ?>
                <div class="terms">
                  ...
                  <br>
                  <b class="bold">You CAN:</b><br> 1) Use on one (1) domain only, additional license
                  purchase required for each additional domain.<br> 2) Modify or edit as you see fit.<br>
                  3) Delete sections as you see fit.<br> 4) Translate to your choice of language.<br>
                  <br><b class="bold">You CANNOT:</b> <br>1) Resell, distribute, give away or trade by any
                  means to any third party or individual without permission.<br> 2) Use on more than one
                  (1) domain.
                  ...
                  <form action="?page=req" method="post">
                    ...
                    <br><br>
                    <button type="submit" class="btn btn-main" id="next-terms" disabled>Continue <svg viewBox="0 0 19 14" xmlns="http://www.w3.org/2000/svg" width="18" height="18">
                        <path fill="currentColor" d="M18.6 6.9v-.5l-6-6c-.3-.3-.9-.3-1.2 0-.3.3-.3.9 0 1.2l5 5H1c-.5 0-.9.4-.9.9s.4.8.9.8h14.4l-4 4.1c-.3.3-.3.9 0 1.2.2.2.4.2.6.2.2 0 .4-.1.6-.2l5.2-5.2h.2c.5 0 .8-.4.8-.8 0-.3 0-.5-.2-.7z">
                        </path>
                      </svg></button>
              ...
              <?php } else if ($page == 'finish') { ?>
                <div class="req">
                  <p>Congratulations! WoWonder script has been successfully installed and your website is
                    ready.</p>
                  <p>Login to your admin panel to make changes and modify any default content according to
                    your needs.</p>
                  <br>
                  <p>If you have any question, please <a href="mailto:wowondersocial@gmail.com" class="main">let us know</a>.</p>
                  <br><br>
                  <a href="../?access=true" class="btn btn-main" style="line-height: 50px;">Let's Start
                    !</a>
                </div>
                ...
                <div class="req">
                  ...
                  <form action="?page=installation" method="post" class="form-horizontal install-site-setting">
                    <div class="form-group">
                      ...
                      <div class="col-md-8">
                        <input type="text" class="form-control" name="purshase_code" value="<?php echo (!empty($_POST['purshase_code'])) ? trim($_POST['purshase_code']) : ''; ?>" placeholder="Enter Anything" autofocus>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-8">
                        ...
                        <span class="help-block">Examples: <br>http://siteurl.com<br>
                          http://www.siteurl.com<br> http://subdomain.siteurl.com<br>
                          http://siteurl.com/subfolder<br> You can use https:// too.</span>
                      </div>
                    </div>
                    <hr>
                    <div class="form-group">
