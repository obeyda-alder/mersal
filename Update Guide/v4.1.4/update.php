                  ...
                  <div>
                     ...
                     <div class="setting-well">
                        ...
                        <ul class="wo_update_changelog">
                              <li> [Fixed] multi user delete was not working from admin panel.</li>
                              <li> [Fixed] slow load when visiting the website first time.</li>
                              <li> [Fixed] br tag showing on user about, pages, groups and products.</li>
                              <li> [Fixed] wasabi not working with nodejs.</li>
                              <li> [Fixed] jpg images with webp mime type returning null images. </li>
                              <li> [Fixed] videos are playing even though you play another video.</li>
                              <li> [Fixed] coinbase payment returning to 500 Internet server error when canceling a payment.</li>
                              <li> [Fixed] profile completion system not working in Instagram mode.</li>
                              <li> [Fixed] movies cannot be added by moderators.</li>
                              <li> [Fixed] showing long balance in my earnings page.</li>
                              <li> [Fixed] post limit per hour not working.</li>
