            ...
            <div class="col-md-10">
               <div class="wo_install_wiz">
                 <?php if ($updated == false) { ?>
                  <div>
                     <h2 class="light">Update to v3.0.4 </span></h2>
...
<script>  
var queries = [
    "UPDATE `Wo_Config` SET `value` = '3.0.4' WHERE `name` = 'version';",
    "ALTER TABLE `Wo_Posts` ADD `send_notify` VARCHAR(11) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' AFTER `agora_sid`;",
    "ALTER TABLE `Wo_Posts` CHANGE `postLinkContent` `postLinkContent` TEXT CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '';"
